const { getUserCriptosByUsernameFromFile, saveUserCriptoFromDBFile, findUserCriptoFromDBFile } = require("../data/users.data");
...
async function saveUserCripto(username,cripto) {
  ...
  async function deleteUserCripto(username,criptoId) {
    return deleteUserCriptoFromDBFile(username,criptoId);
  }
